...
/* Brand glyphs, inlined as SVG paths — no icon library in the tree. Each
   button is icon-only, so the accessible name lives on the anchor itself. */
const glyphs = {
  linkedin:
...
/**
 * The only conversion on the site. PRODUCT.md is explicit: contact is LinkedIn
 * and GitHub only — no phone, no email, no contact form — and on mobile at
 * least one of them must be reachable without scrolling. Instagram rides along
 * as a social link, not a contact channel.
 */
  ...
  return (
    <div className={`flex flex-wrap items-stretch gap-step-3 ${className}`}>
      <a
        ...
        className="caption inline-flex items-center bg-ink px-step-4 py-step-3 text-paper transition-colors duration-150 hover:bg-print-cyan"
      >
      ...
      <a
        ...
        className="caption inline-flex items-center border-2 border-ink px-step-4 py-step-3 text-ink transition-colors duration-150 hover:bg-ink hover:text-paper"
      >
